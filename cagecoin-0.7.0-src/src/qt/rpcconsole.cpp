...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the CageCoin RPC console.") + "<br>" +
...
void RPCConsole::setNumBlocks(int count, int countOfPeers)
{
    ...
    if (count > countOfPeers)  ui->totalBlocks->setText(QString::number(count));  // CAGE 0.7.0: if actual block count higher than estimated, show actual
}
