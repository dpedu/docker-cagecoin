...
static const int64 MAX_MONEY = 10000000000ULL * COIN; // CageCoin: maximum of 100B coins (given some randomness), max transaction 10,000,000,000 for now
/* ^^^ 'ULL' suffix added to prevent Gitian compile choking on a very large constant that won't fit into 32 bits */
...
static const uint256 hashGenesisBlockOfficial("0x0b2f16b1c87db05aa0d4a4e27ca7b93c65980fd242714640293494d4a0a0e34c");
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > 100 * COIN * 1440 / 250; // CageCoin: 1440 blocks found a day. Priority cutoff is 100 cagecoin day / 250 bytes.
    }
